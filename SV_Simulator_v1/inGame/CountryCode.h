...
enum CountryCode {
	...
	Bolivia, Brazil, Brunei, Bhutan, Botswana, Central_African_Republic,
	Canada, Switzerland, Chile, China, Ivory_Coast, Cameroon,
	Democratic_Republic_of_the_Congo, Republic_of_Congo, Colombia,
	Costa_Rica, Cuba, Northern_Cyprus, Cyprus, Czech_Republic,
	Germany, Djibouti, Denmark, Dominican_Republic, Algeria,
	...
	Greece, Greenland, Guatemala, Guyana, Honduras, Croatia,
	Haiti, Hungary, Indonesia, India, Ireland, Iran, Iraq,
	Iceland, Israel, Italy, Jamaica, Jordan, Japan, Kazakhstan,
	Kenya, Kyrgyzstan, Cambodia, South_Korea, Kosovo,
	Kuwait, Laos, Lebanon, Liberia, Libya, Sri_Lanka,
